  ...
  form.forEach(function (item) {
    item.addEventListener("submit", function (e) {
      ...
      postData("assets/server.php", formData).then(function (res) {
        ...
        return status.textContent = statusMessage.error;
      }).finally(function () {
        clearInputs();
        setTimeout(function () {
          status.remove();
  ...
  function bindModal(triggerSelector, modalSelector, closeSelector) {
    ...
    trigger.forEach(function (item) {
      return item.addEventListener("click", function (e) {
        return e.target && showModal(e);
      });
    });
    closeBtn.addEventListener("click", closeModal);
    modal.addEventListener("click", function (e) {
      return e.target === modal && closeModal();
    });
  }
...
var tabs = function tabs(tabsWrapperSelector, tabsSelector, contentSelectors, activeClass) {
  var tabsWrapper = document.querySelector(tabsWrapperSelector),
